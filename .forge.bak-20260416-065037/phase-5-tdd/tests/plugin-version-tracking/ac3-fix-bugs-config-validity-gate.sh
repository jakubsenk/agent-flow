...
# AC-5: Step 0b references implement-feature.md Step 0b as canonical source
...
# AC-6: Step 0b checks all 4 required config sections on one line/block
...
# AC-9: Step 0b says "proceed to Step 1" (matching fix-bugs Step 1 = Fetch bugs)
...
[ "$FAIL" -eq 0 ] && echo "PASS: fix-bugs SKILL.md Config Validity Gate (Step 0b) is present and correctly structured (AC-4 to AC-9)"
exit "$FAIL"
