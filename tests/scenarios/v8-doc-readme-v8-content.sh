...
# Description: README.md has "17 agents", "18 skills", v8.0.0 reference,
...
# ---------------------------------------------------------------------------
if [ "$FAIL" -eq 0 ]; then
  echo "PASS: AC-DOC-012 — README.md v9.5.0 content verified (17 agents, 18 skills, v8.0.0 ref, migration link)"
fi
exit "$FAIL"
