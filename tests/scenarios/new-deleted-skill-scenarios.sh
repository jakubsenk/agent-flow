#!/bin/bash
# Covers: AC-52 (deleted-skill-migrate-config scenario exists and asserts deletion),
#         AC-53 (deleted-skill-estimate scenario exists and asserts deletion),
#         AC-54 (deleted-skill-pipeline-status scenario exists and asserts deletion),
#         AC-55 (deleted-skill-scaffold-validate scenario exists and asserts deletion)
set -e
