...
# Issue templates
check_pair ".gitea/issue_template/bug_report.md" ".github/ISSUE_TEMPLATE/bug_report.md"
check_pair ".gitea/issue_template/feature_request.md" ".github/ISSUE_TEMPLATE/feature_request.md"
