...
if echo "$fixbugs_agg" | grep -q "Fix Verification\|fix-verification\|fix_verification"; then
...
if echo "$impl_agg" | grep -q "Feature Verification\|feature-verification\|feature_verification"; then
