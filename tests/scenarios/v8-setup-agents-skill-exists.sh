...
# ---------------------------------------------------------------------------
# Assertion 4: skill count includes setup-agents (18 total post-v9.5.0)
# ---------------------------------------------------------------------------
echo "--- Assertion 4: skills/ count is 18 (includes setup-agents, post-v9.5.0) ---"
...
if [ "$SKILL_COUNT" -eq 18 ]; then
  ...
  echo "INFO: skills/ contains $SKILL_COUNT SKILL.md files (expected 18 post-v9.5.0)"
  fail "skills/ has $SKILL_COUNT SKILL.md files — expected 18 post-v9.5.0"
fi
