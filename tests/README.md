...
Test suite for verifying pipeline logic. Contains a mock MCP server, test runner, and 231 automated scenarios.
...
├── scenarios/             ← 231 test scenarios (bash scripts)
...
The table below shows a representative sample of scenarios — it is **not** an exhaustive list. The full suite contains 231 scenarios in `tests/scenarios/`.
