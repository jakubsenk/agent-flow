...
- `test.agent_name`      = `"ceos-agents:test-engineer"`
- `test.stage_name`      = `"test"`
- `test.dispatched_at`   = current ISO-8601 UTC timestamp
- `test.dispatch_witness` = sha256("ceos-agents:test-engineer|sonnet|<prompt_head_128>")
...
You MUST invoke `Task(subagent_type='ceos-agents:test-engineer', model='sonnet')`.
