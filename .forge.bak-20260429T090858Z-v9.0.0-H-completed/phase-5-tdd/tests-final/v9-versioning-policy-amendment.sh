...
# EXPECTED ON v8.0.0: FAIL (CLAUDE.md has not been amended yet)
# EXPECTED ON v9.0.0: PASS (CLAUDE.md has both the new MAJOR row text and clarification paragraph)
set -uo pipefail
