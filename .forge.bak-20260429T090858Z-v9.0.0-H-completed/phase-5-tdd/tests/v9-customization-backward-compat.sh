...
#          Verifies: (1) core/agent-override-injector.md is unchanged from v8.0.0 (REQ-H-020),
...
# EXPECTED ON v8.0.0: PASS (injector unchanged; no examples collide — this test is a green-baseline guard)
# EXPECTED ON v9.0.0: PASS (same — backward-compat preserved; injector untouched)
set -uo pipefail
